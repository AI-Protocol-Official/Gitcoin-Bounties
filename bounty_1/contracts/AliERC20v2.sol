 ...
 *      - Supports atomic allowance modification, resolves well-known ERC20 issue with approve (ISBN:978-1-7281-3027-9)
...
contract AliERC20v2 is ERC1363, EIP2612, EIP3009, AccessControl {
	 ...
	 */
	uint256 public constant TOKEN_UID = 0xd0f06275a823448e029d160a0e5ce8c849efc41a5aaa696af104f4765a2c3a6a;
	 ...
	 */
	string public constant override name = "Artificial Liquid Intelligence Token";
	 ...
	 */
	string public constant override symbol = "ALI";
	 ...
	 */
	event Transferred(address indexed by, address indexed from, address indexed to, uint256 value);
	 ...
	 */
	event Approved(address indexed owner, address indexed spender, uint256 oldValue, uint256 value);
	...
	function supportsInterface(bytes4 interfaceId) public pure override returns (bool) {
		...
		// note: ERC1363 includes ERC20 and ERC165
		return interfaceId == type(ERC1363).interfaceId
	...
	function __transferFrom(address _by, address _from, address _to, uint256 _value) private {
		...
		if(_from != _by) {
			...
			if(_allowance < type(uint256).max) {
				...
				emit Approved(_from, _by, _allowance + _value, _allowance);
		...
		emit Transferred(_by, _from, _to, _value);
	...
	function __approve(address _owner, address _spender, uint256 _value) private {
		...
		emit Approved(_owner, _spender, _oldValue, _value);
	...
	function permit(address _owner, address _spender, uint256 _value, uint256 _exp, uint8 v, bytes32 r, bytes32 s) public override {
		...
		// derive signer of the EIP712 Delegation message, and
